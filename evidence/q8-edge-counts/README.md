...
Method: `afl-fuzz -V 30` short runs using the ASan-free AFL-instrumented libpng build.
...
| --- | --- | ---: | ---: | ---: | ---: |
| Minimal libpng probe | `afl-clang-fast -g -O1` + `/build/install_no_asan/lib/libpng12.a` | 49 | 3090 | 1.59% | 2248.10 |
| Final decoder harness | `make build-no-asan` | 808 | 3130 | 25.81% | 1682.22 |
